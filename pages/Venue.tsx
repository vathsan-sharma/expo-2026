        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center mb-16 md:mb-24">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8">
              ...
              >
                <MapPin className="w-4 h-4" /> Exhibition Place, Toronto
              </motion.div>
            </div>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            <p className="text-white/60 text-xl leading-relaxed mb-8 font-medium italic">
              AEEE 2026 will be hosted at the prestigious Exhibition Place, one of Canada's largest and most advanced exhibition facilities.
            </p>
        ...
        <div className="mb-16 md:mb-24">
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="p-8 md:p-12 border border-white/10 space-y-8 bg-white/5 rounded-sm"
            >
              ...
              <p className="text-white/60 text-lg font-medium italic leading-relaxed">
                We have partnered with leading hotels near the Exhibition Place to offer exclusive rates for AEEE 2026 delegates.
              </p>
